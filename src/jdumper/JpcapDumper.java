...
public class JpcapDumper
{
	...
	public static void main(String[] args) throws Exception{
		...
		try{
			Class.forName("jpcap.JpcapCaptor");//加载类
		...
		JDPacketAnalyzerLoader.loadDefaultAnalyzer();//装载分析器等
